...
def convert_to_pico_header(image_path, header_name, n_colors=16, saturation_boost=1.5, sample_scale=0.2):
    ...
    # FIX: Force first slot to Black to stop "red noise" in shadows
    palette[0] = [0, 0, 0]
...
# Run the script
convert_to_pico_header("mark.jpg", "image_asset")